...
function SpaceWeatherIndicator({ level }: { level : string }) {
  const getStatusColor = (level : string) => {
    switch (level) {
      ...
      case 'extreme': return 'bg-pink-600';
...
export default function GeoMagneticWidget() {
    ...
    if (loading) {
      ...
      const currentGeomagneticData = error ? geomagneticData : { ...geomagneticData, ...geophysicalweather };
          ...
          <div className="grid gap-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium dark:text-gray-300">{currentGeomagneticData.solarFlux}</span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium dark:text-gray-300">{currentGeomagneticData.kIndex}/9</span>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-medium dark:text-gray-300">{currentGeomagneticData.aIndex}/100</span>
              </div>
